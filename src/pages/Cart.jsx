...
import { removeFromCart, checkout } from '../redux-toolkit/slice/movieSlice';
...
function Cart() {
  ...
  return (
    ...
    <div className="px-4 py-6 mx-auto max-w-7xl lg:py-4 md:px-6">
      <div>
        <h2 className="mb-8 text-4xl font-bold dark:text-gray-400">My Cart</h2>
        ...
        <div className="p-6 mb-8 border bg-gray-50 dark:bg-gray-800 dark:border-gray-800">
          ...
          {cart.map((cart) => (
            <div key={cart.imdbID} className="flex flex-wrap items-center mb-6 -mx-4 md:mb-8">
              <div className="w-full px-4 mb-6 md:w-4/6 lg:w-6/12 md:mb-0">
              ...
              <div className="w-auto px-4 text-right md:w-1/6 lg:w-2/12 ">
              <button onClick={() => handleRemoveFromCart(cart.imdbID)} className="inline-block px-8 py-4 font-bold text-white uppercase bg-blue-500 rounded-md hover:bg-blue-600" href="#">Remove</button>
              </div>
    ...
    {isModalOpen && <ModalCheckout closeModal={() => setModalOpen(false)} />}
  </section>
